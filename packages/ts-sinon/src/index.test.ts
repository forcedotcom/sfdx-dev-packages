...
import { fromStub, spyMethod, stubCallable, stubInterface, stubMethod, stubObject } from '.';
...
describe('stubs', () => {
    ...
    it('should stub a class instance with private fields', async () => {
        ...
        const stub = stubObject(sandbox, new Target(true), {
            overrideCallable: stubCallable(sandbox, {
                property: 'overridden'
            }, () => 'overridden'),
            overrideMethod() {
        ...
        function useTarget(target: Target): Target { return target; }
    ...
    it('should stub a callable', () => {
        ...
        const stub = stubCallable<Callable>(sandbox, {
            foo: () => 'ret2',
            bar: true
        }, () => 'ret1');
    ...
    it('should stub a private method', () => {
        class Foo {
            ...
            public test(): string { return this.t(); }

            private t(): string { return this.testVal; }
        }
